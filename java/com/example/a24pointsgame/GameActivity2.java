...
public class GameActivity2 extends AppCompatActivity {
    ...
    private List<String> equs = point24.getPoint24Equ(chooseNums);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button backBnt2 = findViewById(R.id.game2_back);  //在退出该功能时，计算这次获得的分数
        backBnt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(GameActivity2.this, "您本次的得分为"+score+"分", Toast.LENGTH_SHORT).show();
    ...
    public void getChallenge(View view) {
        ...
        List<String> equs1 = point24.getPoint24Equ(chooseNums);
        isHave = false;
        int cnt = equs1.size();
        for (int i = 0; i < cnt; i++) {
            msg1.append(i + 1).append("、").append(equs1.get(i)).append("\n");
        }

        text = et.getText().toString();
        Log.e("led", "输入的内容: " + text);
        if(text.length()==0){
            System.out.println("11354");
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle("未输入表达式");
            ...
            if (equs1.contains(text)) {
                // 表达式在equs列表中
                Log.e("led", "输入的内容: " + text);
                System.out.println("用户输入的表达式在equs列表中。");
                isHave = true;
                score++;
                ...
                builder.setPositiveButton("继续挑战！！", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(GameActivity2.this, "正确!", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.show();
                ...
                // 表达式不在equs列表中
                System.out.println("用户输入的表达式不在equs列表中。");
                isHave = false;
                fl1 = false;
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("运算结果");
                builder.setMessage("回答错误或操作不合法!");
                builder.setPositiveButton("重新挑战", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(GameActivity2.this, "加油!", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.show();
            }
            ...
            builder.setIcon(icon)
                    ...
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Toast.makeText(GameActivity2.this, "再试试!", Toast.LENGTH_SHORT).show();
                        }
                    })
