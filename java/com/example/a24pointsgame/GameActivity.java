...
public class GameActivity extends AppCompatActivity {
    ...
    //getTips函数用于24点计算的调用。24点计算主要使用的是point24类中的getPoint24Equ函数。
    public void getTips(View view){
        ...
        //通过boolean型的ishave进行相应的判断，从而变换相应的弹窗的icon图标
        Drawable icon = null;
        if(isHave){
    ...
    //通过switch-case来获取卡牌的名称。这段代码很长也很繁杂，但是逻辑比较简单，即将imageButton的id、相应的drawable图片、curCardName的名字相联系。
